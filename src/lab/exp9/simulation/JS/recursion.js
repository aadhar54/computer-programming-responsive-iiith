window.view = {
  ...
  getInput: function () {
    ...
    if (input === 0) alert('Enter number of disks first !');
    ...
    else if (input < 0 || input > 10 || input % 1 !== 0) alert('Invalid input');
    else {
      ...
      for (i = 0; i < input; i++) elements[i].className += ' ' + this.disks[i];
    }
  },
