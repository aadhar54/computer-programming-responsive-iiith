...
window.view = {
  ...
  activateEvents: function () {
    this.addClickEvent('radioBtn1Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('radioBtn2Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('radioBtn3Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('radioBtn4Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('radioBtn5Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('radioBtn6Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('radioBtn7Id', function () {
      view.setValue('textFieldId', this.value);
    });
    this.addClickEvent('submitBtnId', function () {
      view.validationInput();
    });
    this.addClickEvent('startBtnId', function () {
      view.startStepExecution();
    });
    this.addClickEvent('nextBtnId', function () {
      view.showDayOfWeek();
    });
    this.addClickEvent('resetBtnId', function () {
      view.resetButtonSwitch();
    });
  },
  ...
  showDayOfWeek: function () {
    ...
    this.nextSiblingElement = this.getNextSiblingElement(
      this.currentSiblingElement
    );
    if (
      this.nextSiblingElement.id === 'charId' ||
      this.nextSiblingElement.id === 'strId' ||
      this.nextSiblingElement.id === 'switchId'
    )
      this.codeExecutionWithColour();
    if (this.nextSiblingElement.id === 'case1Id') this.jumpToDay();
    ...
    if (this.nextSiblingElement.id === 'ifId') this.codeExecutionWithColour();
    if (
      this.nextSiblingElement.id === 'closeBrc2Id' ||
      this.nextSiblingElement.id === 'elseId' ||
      this.nextSiblingElement.id === 'elseIfId'
    ) {
